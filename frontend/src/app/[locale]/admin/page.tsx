            ...
            <div style={{ width: '100%', maxWidth: '420px', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: '8px', background: 'rgba(255,255,255,0.05)', padding: '4px', borderRadius: '10px', marginBottom: '20px' }}>
                    <button
                        ...
                        style={{ flex: 1, padding: '10px', border: 'none', borderRadius: '8px', background: mode === 'login' ? 'var(--gold)' : 'transparent', color: mode === 'login' ? '#0a1829' : '#fff', fontWeight: '600', fontSize: '13px', cursor: 'pointer', transition: 'all 0.2s' }}
                    >
                        Kirish (Sign In)
                    </button>
                    <button
                        ...
                        style={{ flex: 1, padding: '10px', border: 'none', borderRadius: '8px', background: mode === 'setup' ? 'var(--gold)' : 'transparent', color: mode === 'setup' ? '#0a1829' : '#fff', fontWeight: '600', fontSize: '13px', cursor: 'pointer', transition: 'all 0.2s' }}
                    >
                        Setup (Sign Up)
                    </button>
                </div>

                <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(201,168,76,0.2)', borderRadius: '16px', padding: '32px 40px 40px', backdropFilter: 'blur(20px)' }}>
                    {blocked ? (
                        ...
                        <form onSubmit={mode === 'login' ? handleLogin : handleSetup}>
                            <h2 style={{ fontSize: '16px', color: '#fff', marginBottom: '16px', fontWeight: '600' }}>
                            ...
                            {successMessage && (
                                <div style={{ background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: '8px', padding: '12px 16px', marginBottom: '20px' }}>
                                    <span style={{ color: '#86efac', fontSize: '13px', lineHeight: '1.5' }}>✓ {successMessage}</span>
                                </div>
                            )}
                ...
                <div style={{ textAlign: 'center', marginTop: '24px', fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'rgba(255,255,255,0.3)', letterSpacing: '2px' }}>
